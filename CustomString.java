...
public class CustomString {
	...
	public String remove(String arg) {
		// TODO Implement method
        String newString = "";
		if (this.myString == null || this.isSet == false || this.myString.isEmpty()) 
            return newString;
        else {
            newString = this.myString;
            for(int i=0; i<arg.length(); ++i) {
                if(Character.isLetter(arg.charAt(i))) {
                    newString = newString.replaceAll(arg.charAt(i) + "", "");
                }
            }
            return newString;
        }	
	...
	public String filterLetters(char n, boolean more) {
        // TODO Implement method 
            if (this.myString == null || this.myString.isEmpty() || !this.isSet || !Character.isLetter(n))
        return "";
